...
class ManageAnchorData extends ManageRelatedRecords
{
    ...
    {
        $anchor = $this->getOwnerRecord()->anchors->first();
        ...
        return [
            ProjectResource\Widgets\HelixesTable::make([
                'anchorId' => $anchor->getKey(),
            ]),
        ];
    }
}
